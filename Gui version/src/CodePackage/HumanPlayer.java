...
public class HumanPlayer extends Player {
    ...
    private void saveGame(Scanner scanner) {
        ...
        String saveFilePath = switch (saveChoice) {
            case 1 -> "put ur own path    /Unoproject3/src/resources/savegame.sers";
            case 2 -> "put ur own path    /Unoproject3/src/resources/savegame.ser";
            case 3 -> "put ur own path    /Unoproject3/src/resources/savegame.ser";
